...
\begin{contacts}
	...
	\contact{\cInitiate{}} The other \pShippies{} initiate here at the \pSc{}. \cInitiate{\They} \cInitiate{\doesn't} appreciate the opportunity \cInitiate{\they}  \cInitiate{\have} been given.
