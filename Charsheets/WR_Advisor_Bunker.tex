...
\contact{\cPrincipal{}} An old friend originally hailing from \pShip{} (long before your time though). You have helped \cPrincipal{\them} maintain the school for several decades.
	\contact{?} A spy or informant from \pFarm{} at \pSc{} -- \pFarm{} is too well informed on current events at the school to not have a source of information planted here.  If possible, it would be good to find and neutralize them.
