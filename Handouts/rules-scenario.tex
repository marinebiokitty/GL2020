...
\hline
Out of Game Hand Signal & Make a fist with one hand. Place it on top of your head (visible from in front of and behind you) & You are now out of character (OOC). You may talk and act as your player. This is useful for many things including talking player to player about something that just happened that you need to adjust, stepping out to use the restroom, or because a mechanic told you to.  

This is the main way we ask you to do calibration, including addressing something that needs to change in a scene for your safety or if you need to de-escalate a scene that has become too intense for any reason.  If you are requested by a player to tone it down or change something for their safety and comfort, that is not a request.  You must de-escalate.  

 If someone uses this around you, your character no longer sees theirs. You should ignore OOC players unless they address you directly and ask you to go OOC too to discuss something. If you need to have an extended conversation OOC, we encourage you to step away from ongoing game play so as not to disrupt it. \\

Example:
Players 1 and 2 are playing an intense scene.  As their character, Player 2 accuses player 1’s character of keeping a secret from them and begins to yell.  Player 1 realizes that they are feeling trapped and this is too much for them at the moment.  They raise the OOC sign, which stops the scene.
 Player 1: “I need you to de-escalate the scene.  I am feeling pretty overwhelmed”  
Player 2 “What can I do to help?”  
Player 1: “I need a bit of space and a moment. Then could we continue this without as much yelling and with more distance between us?”
Player 2:  “Of course!  Let me know when you are ready.  I will go get a drink of water in the meantime  
    \hline
...
\begin{center}
\includegraphics[width=0.6\textwidth]{\gamepath/images/CombatImage.png}
\end{center}
