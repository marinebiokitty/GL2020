...
\textcolor{red}{Some characters have the ability to create curses. These are represented by item cards that describe their effects. Curses begin as a latent magical effect, but can be activated in one of several ways. Once activated, you should write ``expended'' on the card and the person upon whom the curse is active should carry it around with them until the effect ends to remind themselves of the effect. ``Expended'' curses no longer represent physical items, they are just OOC reminders.}

\textcolor{red}{Unless you know otherwise (e.g. the item card for the curse says someting different) You may:}
\begin{itemize}
	\textcolor{red}
...
\textcolor{red}{Some curses may specify more stringent requirements for activation.}
