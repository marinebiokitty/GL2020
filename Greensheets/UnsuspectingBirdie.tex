...
\begin{enumerate}
  \item Place the activated amulet in the target’s possession for a minimum of 2 minutes. (you can knock them out and place it on them, pick pocket it onto them and then retrieve it, or something else of your own devising.)
  \item Open the Amulet item and write the name of the character that the amulet is attuned to on the paper inside. Replace the paper inside the amulet.
\end{enumerate}
