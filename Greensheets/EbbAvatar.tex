...
\end{enumerate}
  ...
  \end{enumerate}
  \item Consequences of the Ritual — These ONLY occur if the ritual completes successfully: (They would be circumvented if this could be done in the Divine Realm.)
  \begin{enumerate}
