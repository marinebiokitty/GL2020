...
Take a copy of \textbf{the Greensheet}, \textbf{the ability}, and a \textbf{Yellow headband}.
}
...
\NEW{SignMedium}{\sGardenDay}{
  ...
  \s\MYitems {\multi{11}{\iSunflower{}\iMorningGlory{}\iHollyhock{}\iLily{}}}
}
...
\NEW{SignMedium}{\sGardenNight}{
  ...
  \s\MYitems {\multi{11}{\iNightshade{}\iMoonflower{}\iFlameOrchid{}}}
}
...
\NEW{SignSmall}{\sGardenBrickTwo}{
  \s\MYname	{Glowing Blue Brick}
  \s\MYloc	{Garden}
  \s\MYtext	{You find a glowing blue brick in the retaining wall. If you bring \textbf{3} advisors to this location, you may retrieve whatever is in the envelope. Once you have succeeded in this task, remove this sign and envelope (but not the two signs on top of it) and discard them to the nearest stock.
	}
...
\NEW{Sign}{\sFadedTombstone}{
  ...
  \s\MYitems {\iStoneFlower{}\iStoneFlower{}\iStoneFlower{}}
}
...
\NEW{SignSmall}{\sGraveyardBrickTwo}{
  \s\MYname	{Glowing Blue Brick}
  \s\MYloc	{Graveyard}
  \s\MYtext	{You find a glowing blue brick in the side of the fireplace. If you bring \textbf{5} people, each from a different nation/cohort combination (e.g you can’t have 2 students from the \pFarm{}), you may retrieve whatever is in the envelope. Once you have succeeded in this task, remove this sign and envelope (but not the two signs on top of it) and discard them to the nearest stock.
	}
	\s\MYitems {\iEdgePiece{}}
}
...
\NEW{SignSmall}{\sTrainingBrickTwo}{
  \s\MYname	{Glowing Blue Brick}
  \s\MYloc	{Training Field}
  \s\MYtext	{You find a glowing blue brick in the pillar holding up the combat circle. If you bring \textbf{3} citizens of the \pShip{} to this location, you may retrieve whatever is in the envelope. Once you have succeeded in this task, remove this sign and envelope (but not the two signs on top of it) and discard them to the nearest stock.
	}
	\s\MYitems {\iEdgePiece{}}
}
...
\NEW{SignMedium}{\sCursedCodicesEnvelope}{
  ...
  \s\MYloc	{The Library}
  \s\MYtext	{Only remove items from this envelope if instructed to do so.}
	\s\MYitems {\multi{16}{\iHonesty{}\iBlindness{}\iWeakness{}}
\multi{8}{\iInsight{}}
...
\NEW{Sign}{\OldWingIntro}{
  ...
  \s\MYtext	{Here you find an abandoned and ruined building. It seems to have collapsed in some calamity. It is quite dangerous to wander around in, and is definitely off limits for students.
	...
	If you wish to scoop up a spider web from this location, you may do so, but you must wait 5 minutes before you take another.}
}
...
\NEW{SignSmall}{\sGHBrickTwo}{
  \s\MYname	{Glowing Blue Brick}
  \s\MYloc	{Great Hall}
  \s\MYtext	{You find a glowing blue brick in the side of the fireplace. If you bring enough people to have a total L-Score = \textbf{4}, you may retrieve whatever is in the envelope. Once you have succeeded in this task, remove this sign and envelope (but not the two signs on top of it) and discard them to the nearest stock.
	}
	\s\MYitems {\iEdgePiece{}}
}
...
\NEW{SignMedium}{\sCleaningReceptacleBlue}{
  ...
  \s\MYloc	{Ritual Space}
  \s\MYtext	{k ball pit balls go here. See the ``\sCleaningInstructions{}'' sign nearby for instructions.}
}
