...
\NEW{SignMedium}{\sGardenDay}{
  ...
  \s\MYitems {multi{10}{\iFlameOrchid{}\iMorningGlory{}\iHollyhock{}}}
}
...
\NEW{Sign}{\sTrainingFieldGeneral}{
  ...
  \s\MYitems {multi{10}{\iLily{}\iEagleFeather{}}}
}
...
\NEW{Sign}{\sSignF}{
  ...
  \s\MYtext	{\emph{(OOC: This sign contains instructions for how to make the pedestals necessary to hold the relics for the Ritual to Control the Storm. Feel free to ignore this sign unless directed to it by a greensheet.)}
	...
	If you wish to build a pedestal to hold one of the Relics for the Ritual to Control the Storm, follow these instructions:

\begin{enumerate}
	\item Find the following items around the College and bring them here:
	\begin{itemize}
		\item \iWoodenPlank{} x2
		\item \iFancyCloth{} x1
		\item \iBrassNails{} x1
	\end{itemize}
	...
	\item Take 1 instance of the ``\iPedestalForRelic{}'' item from the envelope attached to this sign.
	\begin{itemize}
		\item Discard the item cards for the supplies to the nearest stock.
		\item See a GM for the Phys. Rep.
	\end{itemize}
\end{enumerate}
	
The pedestal should probably be placed in the Ritual Space after it is built.

A total of \textbf{3 pedestals} must be built in preparation for the Ritual to Control the Storm. You may not build more than 3 pedestals, so don't lose the ones you make. Each pedestal requires new instances of the supplies, and a new round of roleplay to build. Any 3 characters may build them however; there may be as much or as little overlap of characters as everyone wishes.
	}
