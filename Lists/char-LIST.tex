...
\NEW{PC}{\cPrince}{
  \s\MYname	{Princess/Princet \pre Sansum Sunstruck}
	\s\MYfirst {Princess/Princet \pre Sansum}
	\s\MYlast {Sunstruck}
...
\NEW{PC}{\cChupAvenger}{
  ...
  \s\MYblues	{\bWorld{}\bSchool{}\bDramatisPersonae{}\bVikings{}\bTeacherBlue{}\bCultAvenger{}}
