...
\NEW{PC}{\cChupLeader}{
  ...
  \s\MYabils	{\aManipulateVoteThree{}}
...
\NEW{PC}{\cJuniorStatesman}{
  ...
  \s\MYabils	{\aPreviewVoteOne{}\aManipulateVoteOne{}}
...
\NEW{PC}{\cBunker}{
  ...
  \s\MYblues	{\bWorld{}\bSchool{}\bDramatisPersonae{}\bVikings{}\bAdvisorBlue{}}
  \s\MYgreens	{\gTreaty{}\gWRAdvisorRanking{}}
  \s\MYabils	{\aExamineBunkers{}\aUseTass{}}
