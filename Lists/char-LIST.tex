...
\NEW{PC}{\cLibAssist}{
  ...
  \s\MYgreens	{\gWhatHappenedSixYearsAgo{}\gVotingInstructions{}\gCoSStudentMorality{}}
  \s\MYabils	{}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYcr{2}
...
\NEW{PC}{\cAdopted}{
  ...
  \s\MYblues	{\bWorld{}\bSchool{}\bDramatisPersonae{}\bStudentBlue{}\bAgrarians{}}
  \s\MYgreens	{\gVotingInstructions{}\gCoSStudentMorality{}\gMusicBox{}\gPunishKidnappers{}}
  \s\MYabils	{}
...
\NEW{PC}{\cPrince}{
  ...
  \s\MYblues	{\bWorld{}\bSchool{}\bDramatisPersonae{}\bTeacherBlue{}\bAgrarians{}}
  \s\MYgreens	{\gUnsuspectingBirdie{}\gCrownPrince{}}
  \s\MYabils	{\aTransferVoteOne{}}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYcr{2}
...
\NEW{PC}{\cMusic}{
  ...
  \s\MYblues	{\bWorld{}\bSchool{}\bDramatisPersonae{}\bTeacherBlue{}\bAgrarians{}}
  \s\MYgreens	{\gPassingOutVotes{}\gCeremonyOfExcellence{}\gPreparingTheRitual{}}
...
\NEW{PC}{\cEvil}{
  ...
  \s\MYgreens	{\gAssassinateWarlord{}}
  \s\MYabils	{\aPreviewVoteOne{}}
...
\NEW{PC}{\cTechStar}{
  ...
  \s\MYgreens	{\gVotingInstructions{}\gFPFStudentMorality{}}
...
\NEW{PC}{\cAmbition}{
  ...
  \s\MYblues	{\bWorld{}\bSchool{}\bDramatisPersonae{}\bTech{}\bStudentBlue{}}
  \s\MYgreens	{\gVotingInstructions{}\gFPFStudentMorality{}\gFaledonHeir{}}
  \s\MYabils	{\aPreviewVoteOne{}}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYcr{2}
...
\NEW{PC}{\cScholarship}{
  ...
  \s\MYgreens	{\gVotingInstructions{}\gFPFStudentMorality{}\gUnsuspectingBirdie{}}
...
\NEW{PC}{\cBeetle}{
  ...
  \s\MYgreens	{\gPassingOutVotes{}\gPreparingTheRitual{}\gLeyLines{}}
  \s\MYabils	{\aManipulateVoteOne{}}
...
\NEW{PC}{\cAntiChup}{
  ...
  \s\MYgreens	{\gUnsuspectingBirdie{}}
  \s\MYabils	{\aPreviewVoteOne{}}
...
\NEW{PC}{\cAssistantScientist}{
  ...
  \s\MYgreens	{\gMindWipe{}\gPreparingTheRitual{}}
  \s\MYabils	{}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYcr{2}
...
\NEW{PC}{\cInitiate}{
  ...
  \s\MYgreens	{\gBadLuckCurse{}\gVotingInstructions{}\gWRStudentMorality{}}
  \s\MYabils	{}
...
\NEW{PC}{\cFlowPriest}{
  ...
  \s\MYgreens	{\gMagicBeans{}\gPreparingTheRitual{}}
  \s\MYabils	{\aTransferVoteOne{}}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYcr{2}
...
\NEW{PC}{\cPrincipal}{
  ...
  \s\MYblues	{\bWorld{}\bSchool{}\bDramatisPersonae{}\bVikings{}\bTeacherBlue{}}
  \s\MYgreens	{\gVotingInstructions{}\gPassingOutVotes{}\gCeremonyOfExcellence{}\gHireTeacher{}\gLeyLines{}}
