...
\PRESETS{NPC}{
	\badgefalse\sd\MYgroupstr{npc}
	\intromap{{\full}{ }{(\MYcharpronouns)}}
  \def\intros{{\full}{'s }{(\MYcharpronouns)}}
}
...
\NEW{PC}{\cChupAvenger}{
  \s\MYname	{Brooke \suf of 4th Fleet, Pink Coral Ship} % Barnaby
