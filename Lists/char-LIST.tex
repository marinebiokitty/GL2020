...
\NEW{PC}{\cChupStudent}{
  ...
  \s\MYabils	{\aPreviewVoteThree{}\aStealVoteThree{}\aManipulateVoteOne{}}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYcr{2}
}
...
\NEW{PC}{\cHedonist}{
  ...
  \s\MYgreens	{}
  \s\MYabils	{}
  \s\MYitems	{\iSignetRing{}\iPitcher{}}
  \s\MYwhites	{}
  \s\MYcr{2}
}
...
\NEW{PC}{\cChupInventor}{
  ...
  \s\MYgreens	{}
  \s\MYabils	{\aUseTass{}\aPreviewVoteThree{}}
...
\NEW{PC}{\cAntiChup}{
  ...
  \s\MYabils	{\aPreviewVoteOne{}}
  \s\MYitems	{\iChargingStone{}\iInvisibilityCloak{}}%Charged stone
  \s\MYwhites	{}
  \s\MYcr{2}
}
