...
\PRESETS{Char}{
  \FD\MYdesc	{} %% badge description
	...
	\newstat\MYvScore	{V-Score}{VS}{} % Chups and Avengers
  \newstat\MYsScore	{S-Score}{SS}{} % knows about the baby sea serpent
  \newstat\MYlScore	{L-Score}{LS}{} % library navigation bonus
  \newstat\MYfScore	{F-Score}{FS}{} % is eligible as the faledon heir
...
\NEW{PC}{\cPrincipal}{
  ...
  \s\MYblues	{\bWorld{}\bSchool{}\bDramatisPersonae{}\bVikings{}\bTeacherBlue{}}
  \s\MYgreens	{\gVotingInstructions{}\gPassingOutVotes{}\gCeremonyOfExcellence{}\gHireTeacher{}\gLeyLines{} \gNewPrincipal{}\gPreparingTheRitual{}}
