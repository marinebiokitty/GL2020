...
\NEW{ItemEnvelope}{\iScryingAmulet}{ %Prince
  \s\MYname	{A Scrying Amulet}
  \s\MYnumber	{9848}
  \s\MYtext	{This amulet has a dark surface. It is theoretically possible to attune an item such as this to a specific target or location. You may freely open this item to see what it is attuned to, but you may not change the attunement, or use it to scry unless you have a separate ability that describes how to do that.}
  \s\MYcontents	{This amulet is attuned to: \underline{\hline{2cm}}}
}
...
%\NEW{ItemEnvelope}{\iInvisibilityCloak}{ %%\cScholarship and \cAntiChup
  %\s\MYname	{Cloak of Invisibility}
  %\s\MYnumber	{4541} %Checknumber
...
\NEW{ItemEnvelope}{\iMagicTag}{ %%\cScholarship
  \s\MYname	{Magical Tracking Tag}
  \s\MYnumber	{9596}
  \s\MYtext	{Open when you notice you have this item in your possession. This item may be shown to other characters but may not be given away, taken away or destroyed, unless you find a specific mechanic saying otherwise.}
  \s\MYcontents	{What in the name of all the Deities is this thing? You definitely didn’t have it at the start of the Time of Deciding. It gives you a very uncomfortable feeling, and it seems to be impossible to remove. The research notebook entitled ``\nGetItOff{}'' is now yours to work with.}
	\s\MYgreens	{\nGetItOff{}}
}
...
\NEW{ItemEnvelope}{\iMirror}{  
  ...
  \bulky	{1}
	\unstash{}
  \s\MYtext	{A large standing mirror. The frame is finely engraved silver. Despite being ancient, it shows not a speck of tarnish. The frame of this Relic was crafted by the Church of \cTechGod{}, and the mirrored surface gifted by \cTechGod{} in time immemorial.
...
As long as this Relic is attuned,  it has the power to compel the truth from its target. Using this effect will cause the relic to deattune. See the associated greensheet (\gTruthRelic{}) for details. If the item changes hands, make sure the greensheet goes with it.
...
As long as this Relic is attuned, it has the power to boost your CR for 1 attack by +3, allow you to attack an Avatar of one of the Deities, or allow you to kill someone without suffering the usual consequences. Using any one of these effects will cause the relic to deattune. See the associated greensheet (\gDeathRelic{}) for details. If the item changes hands, make sure the greensheet goes with it.
...
As long as this Relic is attuned to someplace, it has the power to temporarily improve your luck. Using this effect will cause the relic to deattune. See the associated greensheet (\gLuckRelic{}) for details. If the item changes hands, make sure the greensheet goes with it.

Relics that are attuned will have a piece of paper inside the envelope. You may open the envelope at any time to check if there is a piece of paper inside. \textbf{DO NOT READ the paper if present.}
	}
  \s\MYcontents	{Current Attunment: N/A; don't put this paper in during prod.}
...
\NEW{ItemEnvelope}{\iCourage}{
  ...
  \s\MYtext	{Once activated, whoever this cure is active on should open the envelope and remove it's contents. Write ``expended'' on the paper, and keep it with you as a reminder of the effects until they wear off. Discard this envelope to the nearest stock.}
	\s\MYcontents {You feel a powerful strength roaring through you. \emph{(OOC: Increase your current and maximum CR by +1 for 10 minutes)}}
}
...
\NEW{ItemEnvelope}{\iWeakness}{
  ...
  \s\MYnumber	{9019}
  \s\MYtext	{Once activated, whoever this cure is active on should open the envelope and remove it's contents. Write ``expended'' on the paper, and keep it with you as a reminder of the effects until they wear off. Discard this envelope to the nearest stock.}
	\s\MYcontents {Your body feels heavy, as if you’re dragging a heavy weight, even though there’s nothing behind you. You know you can’t act as quickly now. \emph{(OOC: -1 CR. Decrease your current and maximum CR by 1 for 10 minutes.)} }
}
...
\NEW{ItemEnvelope}{\iSight}{
  \s\MYname	{Cure: Sight of the Falcon}
  \s\MYnumber	{9307}
  \s\MYtext	{Once activated, whoever this cure is active on should open the envelope and remove it's contents. Write ``expended'' on the paper, and keep it with you as a reminder of the effects until they wear off. Discard this envelope to the nearest stock.}
	\s\MYcontents {Light returns to you. Soft like a candle, but growing steadily brighter. You blink. You see fuzzy shapes. You blink again. Color returns. You blink once more, and your sight is restored. \emph{(OOC: if you were under the effects of the \iBlindness{}, the effect is immediately ended.)} }
}
...
\NEW{ItemEnvelope}{\iStrength}{
  ...
  \s\MYnumber	{9087}
  \s\MYtext	{Once activated, whoever this cure is active on should open the envelope and remove it's contents. Write ``expended'' on the paper, and keep it with you as a reminder of the effects until they wear off. Discard this envelope to the nearest stock.}
	\s\MYcontents {Your heart skips a beat, then begins to pump harder and your muscles swell under your skin in a not entirely pleasant manner. \emph{(OOC: \textbf{For the next 10 minutes,} you may carry up to 4 hands bulk freely, or drag up to 6.)} }
}
...
\NEW{ItemEnvelope}{\iSkill}{
  ...
  \s\MYnumber	{9526}
  \s\MYtext	{Once activated, whoever this cure is active on should open the envelope and remove it's contents. Write ``expended'' on the paper, and keep it with you as a reminder of the effects until they wear off. Discard this envelope to the nearest stock.}
	\s\MYcontents {A flash of insight appears in your mind like a bird swooping down on unsuspecting prey. It all makes so much sense now! You feel confident you can accomplish your goal in half the time. \emph{(OOC: Through cleverness and strength you are able to reduce the time required for any \textbf{one} mechanic by half. E.g. If something requires meditating for 5 minutes, you may accomplish that thing in 2.5 minutes. If a cooldown is 10 minutes long, you may wait only 5, etc. This includes the charging time for curses.)} }
}
...
\NEW{Item}{\iSunflower}{ 
  \s\MYname	{Sunflower}
  \s\MYnumber	{9349}
  \s\MYtext	{Bright yellow petals surround a broad, brown center full of immature seeds. It has a rather prickly stem.}
}
