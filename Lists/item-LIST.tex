...
If you also have an item in your possession that could be considered sharp enough to pierce skin (e.g.: a knife, a broken piece of glass, etc) or are in a location where such an implement could be trivially found \textbf{(Such locations will specify that you could cut yourself on something.),} you can fill this vial with blood from yourself, a willing other, or someone unable to resist (e.g.: knocked out, or restrained).
}
}
