...
\NEW{Item}{\iCursedLetter}{ %%\cInitiate starts with this
  ...
  \s\MYnumber	{9312}
  \s\MYtext	{A letter from the Fairweather family, addressed to \cInitiate{}. You summarize the gist of the letter as: ``Did you know we are your long lost family? We’d love to get to know you. By the way this letter has a curse enclosed that is now active and it will make your life miserable until you come visit us in the \cFarm{}. Lots of love. Looking forward to meeting you.’’}
}
...
\NEW{ItemEnvelope}{\iHorseshoe}{  
  \s\MYname	{Iron Horseshoe} %Starts with ChupLeader
  \s\MYnumber	{9119}
	\unstash{}
  \s\MYtext	{An iron horseshoe. It radiates a power equal to any of the other Relics, but the essence doesn’t match any of the Patron Deities.
