...
\NEW{Place}{\pArtisan}{ %People who live in the ``Mageocracy'' country
  \s\MYname	{Mage}
}
...
\NEW{Place}{\pChupFol}{ %People who follow the ``Chupacabra'' religion
  \s\MYname	{Follower of Chupacabra}
}
