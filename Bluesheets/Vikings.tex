...
%% Add a bit about how the war is going on, you'd think the pirates would fall in line and get with the program, but they're not and it's frustrating.

%%Most ``merchants'' are extorting local towns as a protection racket.
%%Pirates are dangerous b/c they have people who are willing to take the memory loss to kill people, sink ships, burn crops/structures/etc.
